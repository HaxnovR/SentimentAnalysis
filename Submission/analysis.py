...
def main():
	data = pd.read_excel('./code/Input.xlsx')
	...
	poswords = getwords('./code/MasterDictionary/positive-words.txt')
	negwords = getwords('./code/MasterDictionary/negative-words.txt')
	stopwords = getstop('./code/StopWords/')
